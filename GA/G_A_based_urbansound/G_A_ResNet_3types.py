...
class Random_Finetune_ResNet():
    ...
    def forward(self, learning_rate=0.001):
        ...
        model = tf.keras.Model(inputs, outputs, name="UrbanSound8K_Resnet_model")
...
epoch = 5
batch_size = 32
save_path = 'D:\GH\Audio\GA\pickle_data\\UrbanSound8K\\0715_ResNet50_Population_14'
