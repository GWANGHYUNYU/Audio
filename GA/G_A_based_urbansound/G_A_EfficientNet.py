...
EfficientNet_type = 0   # 0 / 1 / 2 / 3 / 4 / 5 / 6 / 7

lr = 0.0001
epoch = 5
batch_size = 16
save_path = 'D:\GH\Audio\GA\pickle_data\\UrbanSound8K\\0719_EfficientNet_Population_2'

# generate 1st population
genomes = [Random_Finetune_EfficientNet(IMG_SHAPE, EfficientNet_type) for _ in range(N_POPULATION)]
nw_genomes = [Random_Finetune_EfficientNet(IMG_SHAPE, EfficientNet_type) for _ in range(N_POPULATION)]
